...
class RecipeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create recipee' do
    assert_difference('Recipee.count') do
      post recipees_url,
           params: { recipee: { cooking_time: @recipee.cooking_time, description: @recipee.description, name: @recipee.name,
                                preparation_time: @recipee.preparation_time, public: @recipee.public } }
    end
